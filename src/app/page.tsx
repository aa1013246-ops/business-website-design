    ...
    <div dir="rtl" className="font-sans min-h-screen bg-background text-foreground">
      ...
      <section id="hero" className="container mx-auto grid md:grid-cols-2 gap-8 py-14 md:py-20 items-center">
        <div className="space-y-5">
          <h1 className="text-3xl md:text-5xl font-bold leading-tight">
            استقدام موثوق للعمالة المنزلية في الرياض
          </h1>
          <p className="text-muted-foreground text-base md:text-lg">
            كوادر مدربة من جنسيات متعددة وإجراءات سريعة وشفافة متوافقة مع الأنظمة.
          </p>
        ...
        <div className="rounded-2xl border bg-card p-6">
          <Image src="/vercel.svg" alt="صورة توضيحية" width={600} height={400} className="w-full h-auto dark:invert" />
        </div>
      </section>
        ...
        <div className="container mx-auto py-14 md:py-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="rounded-xl border bg-card p-6 space-y-2">
              <h3 className="font-semibold">العمالة المنزلية</h3>
              <p className="text-muted-foreground text-sm">خيارات متعددة حسب احتياج أسرتك مع خبرات سابقة متنوعة.</p>
            </div>
            <div className="rounded-xl border bg-card p-6 space-y-2">
              <h3 className="font-semibold">السائقين الخاصين</h3>
              <p className="text-muted-foreground text-sm">إجراءات سريعة وفحص مهني لضمان الكفاءة.</p>
            </div>
            <div className="rounded-xl border bg-card p-6 space-y-2">
              <h3 className="font-semibold">دعم ما بعد الوصول</h3>
              <p className="text-muted-foreground text-sm">ضمان واستبدالات حسب العقود ودعم مستمر.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              نقدم خدمات استقدام احترافية متوافقة مع الأنظمة وبشراكات موثوقة عبر دول متعددة لضمان الجودة والسرعة.
            </p>
            <ul className="grid sm:grid-cols-2 gap-3 text-sm">
              <li className="rounded-lg border bg-card p-3">عقود رسمية ومعتمدة</li>
              <li className="rounded-lg border bg-card p-3">تكاليف ومواعيد واضحة</li>
              <li className="rounded-lg border bg-card p-3">خبرات مُسبقة مُوثقة</li>
              <li className="rounded-lg border bg-card p-3">دعم بعد التوظيف</li>
            </ul>
          </div>
          <div className="rounded-2xl border bg-card p-4">
            <Image src="/window.svg" alt="نبذة عنا" width={640} height={420} className="w-full h-auto dark:invert" />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto py-14 md:py-20">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="rounded-xl border bg-card p-6 space-y-3">
              <p className="text-muted-foreground">العنوان: 2393 أبي الوليد بن عبد الله، النزهة، الرياض 12473</p>
      ...
      <footer className="border-t">
        <div className="container mx-auto py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-sm">
          <p className="text-muted-foreground">© {new Date().getFullYear()} مصادر. جميع الحقوق محفوظة.</p>
